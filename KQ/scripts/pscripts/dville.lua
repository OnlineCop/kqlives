    ...
    if (get_progress(55) == 0) then
      ...
      if (prompt(7,2,0,"However, I must first ask if","you are willing to help us?","  yes","  no") == 0) then
        ...
        bubble(7,"That is where he",
                 "can be found.","","");
        bubble(200,"Have your people tried to get",
        ...
        bubble(200,"Are trolls common to this area?",
        ...
        bubble(7,"I must say that we suspect that",
                 ...
                 "in these matters.","");
        bubble(200,"Well, don't worry.  We will get",
      ...
      if (get_progress(55) == 3 or get_progress(55) == 4) then
        ...
        bubble(7,"No, I can't say that I have.",
                 ...
                 "troll problem.");
        bubble(200,"Well, yeah I guess that's good.",
