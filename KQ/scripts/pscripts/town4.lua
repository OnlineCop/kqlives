...
function autoexec()
  ...
  if (get_ent_tilex(200) > 93 and get_ent_tilex(200) < 107 and get_ent_tiley(200) > 0 and get_ent_tiley(200) < 12) then
    set_sstone(0);
...
function postexec()
  ...
  if (get_progress(39) == 1) then
    if (get_progress(40) > 0) then
      ...
      bubble(200,b,"","","");
      bubble(200,"Just great... how am I",
                   "supposed to get back?","","");
      wait(100);
      if (get_pidx(0) == 4) then
        if (get_progress(40)-1 == 5) then
          bubble(200,"I have to find him! I'm not letting",
                        "him get away from me that easily.","","");
        else
          bubble(200,"Oh well.","","","");
        end
      else
        bubble(200,"Sigh. I guess I'll just have",
...
function entity_handler(en)
  ...
  elseif (en == 7) then
    ...
    if (get_progress(50) == 0 and get_progress(43) > 0) then
      if (get_progress(42) == 4) then
        ...
        if (get_progress(49) == 1) then
          bubble(200,"But the Coliseum was closed",
                       "when I went there.","","");
          bubble(7,"Yes... well I'm sure it's",
                   "open by now.","","");
          bubble(200,"Isn't that convienent?","","","");
          bubble(7,"Quite.","","","");
        end
        bubble(200,"So, I have to go there and",
                     "ask Trayor for the shield?","","");
        bubble(7,"No, you have to",
                 "fight him for it.","","");
        bubble(200,"Fight, fight, fight.",
                     "that's all I ever do.","","");
        bubble(7,"Well, that's just how",
                 "these things work.","","");
        bubble(200,"Well, I guess I'm off to fight",
        ...
        bubble(200,"Oh... well nothing",
                     "is ever easy right?","","");
        bubble(7,"Not if it's worth doing, no.","","","");
        bubble(200,"Thanks. I'll see you",
    ...
    if (get_progress(50) == 1 and get_progress(42) < 6) then
      ...
      bubble(200,"My friend here brought me",
                   "information about the Band and",
                   "the Armor. We'll have no trouble",
                   "finding it now.");
      bubble(200,"I appreciate all your help in",
