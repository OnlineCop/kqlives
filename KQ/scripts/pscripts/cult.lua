...
function zone_handler(zn)
  ...
  elseif (zn == 11) then
    ...
    if (get_progress(67) == 2) then
      ...
      bubble(200,"Yeah, that avatar wasn't very",
      ...
      bubble(200,"Well, that was partly the reason",
  ...
  elseif (zn == 28) then
    bubble(200,"There is nothing here but",
                 "common supplies.","","");
  ...
  elseif (zn == 29) then
    if (get_progress(67) == 0) then
      ...
      bubble(200,"Your parents sent us",
                   "to rescue you.","","");
      ...
      bubble(200,"Well... I guess we should hurry",
  ...
  if (en == 0) then
    if (get_progress(66) == 0) then
      ...
      bubble(0,"Do you really think that I'm",
               "going to tell you?","","");
      bubble(200,"That depends... do you",
                   "want to live?","","");
