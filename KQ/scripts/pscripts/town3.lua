...
function zone_handler(zn)
  ...
  elseif (zn == 31) then
    bubble(200,"Ten reasons why you should never",
  ...
  elseif (en == 1) then
    if (get_progress(9) == 1) then
      bubble(1,"Yes, I am Tsorin. I understand",
               ...
               "Derig?","");
      bubble(200,"If you mean that old man back",
      ...
      bubble(1,"And I think it has",
               "to be magical.","","");
      bubble(200,"So, how am I supposed to",
      ...
      bubble(1,"However, the temple is the only",
               ...
               "token that you need.","");
      bubble(200,"Well... if there's no other way",
    ...
    if (get_progress(9) == 2 and get_progress(17) == 1) then
      set_progress(9,3);
