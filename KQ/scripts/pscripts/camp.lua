...
function autoexec()
  ...
  set_ent_active(37,0);
  if (get_progress(44) == 0 and get_progress(45) == 0) then
    while (get_progress(45) == 0) do
      a = krnd(8);
      if (a ~= get_pidx(0) and a ~= get_progress(6)-1 and a ~= get_progress(7)-1) then
        set_progress(45,a+1);
      end
    end
  end
  if (get_progress(44) == 0 and get_progress(45) > 0) then
    set_ent_active(37,1);
    set_ent_id(37,get_progress(45)-1);
  end
  refresh();
end
...
function entity_handler(en)
  ...
  elseif (en == 37) then
    ...
    bubble(200,"Hmm... this almost sounds as though",
                 "the whole thing was planned.","","");
    bubble(37,"Hmm...","","","");
    bubble(200,"Excuse me, Mr. Mayor.","","","");
    bubble(4,"Yes?","","","");
    bubble(200,"Do you think that this could",
    ...
    bubble(37,"And here I was blaming myself",
              "for the whole thing.","","");
    bubble(200,"It's not your fault. You did",
