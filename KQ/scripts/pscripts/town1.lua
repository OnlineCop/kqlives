...
function entity_handler(en)
  if (en == 0) then
    ...
    if (get_progress(12) == 0) then
      ...
      if (get_pidx(0) == 4) then
        thought(200,"Geez! What a loser!","","","");
        thought(200,"Maybe I should put him",
                     "out of his misery.","","");
      end
    else
  ...
  elseif (en == 3) then
    if (get_progress(2) == 0) then
      ...
      if (get_pidx(0) == 7) then
        bubble(200,"And what have you discovered?","","","");
        bubble(3,"Um... that there are more",
                 "monsters than usual down there.","","");
        bubble(200,"Oh... good work then.","","","");
        bubble(3,"Thank you!","","","");
        thought(200,"Who hired these guys?","","","");
      end
    else
      if (get_progress(38) == 0) then
