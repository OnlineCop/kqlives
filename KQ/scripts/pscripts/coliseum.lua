...
function entity_handler(en)
  ...
  elseif (en == 6) then
    ...
    if (get_progress(59) == 0) then
      ...
      elseif (a == 1) then
        if (get_progress(59) == 7) then
          ...
          set_progress(50, 1)
          if (get_ent_tilex(200) == get_ent_tilex(6)) then
   ...
   if (get_numchrs()>1) then -- Skip this partnering up bit.
      return
          ...
          set_ent_id(en, get_progress(62) - 1)
          set_ent_active(en, 1)
        else
  ...
  elseif (en == 12) then
    if (get_progress(40) == 0) then
      ...
      bubble(200, "Well, in that case, welcome to the team.")
      bubble(200, "Now, I already found the Opal Helmet and the Opal Shield.")
      bubble(en, "So what about the other stuff? Do you already know where the Band and Armor are?")
      bubble(200, "No... no, I don't know where the other pieces are.")
      ...
      bubble(200, "Speaking of that... where did you go?")
      ...
      bubble(200, "I already snagged the Helmet and the Shield... where are the other parts?")
