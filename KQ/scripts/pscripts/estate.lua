...
function postexec()
  if (get_progress(46) == 1) then
    ...
    bubble(200,"So why are the Embers trying to",
    ...
    bubble(200,"Well, that's good enough for me.",
                 "I will be off then.","","");
...
function zone_handler(zn)
  ...
  elseif (zn == 8) then
    if (get_progress(42) < 4) then
      bubble(200,"That scream came from up here",
  ...
  elseif (zn == 12) then
    if (get_progress(42) < 4) then
      ...
      bubble(1,"Someone stabbed him",
               "in his sleep!","","");
      bubble(200,"Oh no! You were right though,",
      ...
      bubble(200,"Yes, but when I was there to get",
                   "the Helmet back, it all seemed",
                   "as though it was too easy.","");
      bubble(200,"They set me up. They wanted",
      ...
      bubble(1,"You can't marry an ex-thief and",
               ...
               "I'll be alright.","");
      bubble(200,"Are you sure... is there",
                   "anything I can do?","","");
      bubble(200,"I know... I'll take care of that",
      ...
      bubble(200,"Okay... but what about you?",
...
function entity_handler(en)
  ...
  elseif (en == 2) then
    if (get_progress(43) == 0) then
      ...
      bubble(200,"Well there's no need to",
                   "be so rude about it.","","");
      bubble(3,"Shut up!","","","");
      drawmap();
      screen_dump();
      ...
      screen_dump();
      wait(50);
      bubble(200,"Gee... good thing I wore",
