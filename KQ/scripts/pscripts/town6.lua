...
function zone_handler(zn)
  ...
  elseif (zn == 28) then
    bubble(200,"These are fascinating.","","","");
  ...
  elseif (zn == 30) then
    if (get_progress(64) == 1) then
      if (get_numchrs() == 1) then
        bubble(200,"Ugh... I getting real sick of",
                     "this running around crap! Why",
                     "is nothing I need where it's",
                     "supposed to be?");
        bubble(200,"I'll bet that even if I had waited",
  ...
  if (en == 0) then
    ...
    if (get_progress(64) == 0) then
      ...
      if (get_progress(63) == 1) then
        bubble(200,"We were told she was kidnapped,",
        ...
        bubble(200,"What happened to her?",
                     "Where did she go?","","");
      ...
      bubble(0,"They are trying to summon an",
               ...
               "to do it!");
      bubble(200,"Doesn't that mean that",
                   "one of you is also",
      ...
      bubble(200,"By the way, do you know anything",
    ...
    if (get_progress(64) < 3) then
      ...
      bubble(0,"Therefore, any time you need",
               ...
               "only be charged 1gp.","");
      set_progress(72,1);
      bubble(200,"That's very kind of you.",
                   "Thank you!","","");
      ...
      bubble(200,"That's perfect! The next item we",
