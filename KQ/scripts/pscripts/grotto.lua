...
function autoexec()
  ...
  if (get_progress(11) > 1) then
    set_btile(16,14,153);
    set_obs(16,14,1);
  end
  if (get_progress(11) == 3) then
    set_ent_active(0,0);
    set_ftile(20,16,154);
    set_zone(20,16,0);
    set_obs(20,16,1);
...
function zone_handler(zn)
  if (zn == 1) then
    if (get_progress(11) == 2 and get_progress(9) > 0) then
      set_progress(11,3);
    end
    change_map("main",129,19,129,19);
  
  elseif (zn == 2) then
    bubble(200,"Mmmm... cozy.","","","");
  ...
  elseif (zn == 3) then
    if (get_progress(11) == 0) then
      ...
      bubble(200,"I'd rather not go in",
                   "there right now.","","");
    end
  ...
  elseif (zn == 5) then
    if (get_progress(36) == 0) then
      bubble(200,"Hmm... this seems like it should",
                   "do something. But what?","","");
    else
      if (get_progress(36) == 3) then
  ...
  if (en == 0) then
    if (get_progress(9) == 1) then
      ...
      bubble(0,"Good day $0. I've",
               "been expecting you.","","");
      bubble(200,"How could you have been",
      ...
      bubble(0,"I've known for quite",
               "some time now.","","");
      bubble(200,"Are you a friend of his?","","","");
      ...
      bubble(200,"Well, then can you tell me where",
      ...
      bubble(0,"He's the captain of the city",
               ...
               "there.");
      bubble(200,"Can you tell me anything else.","","","");
      ...
      bubble(0,"I have yet to figure out why",
               ...
               "don't trust him.","");
      bubble(200,"Why? What does this Staff do?","","","");
      bubble(0,"I don't know, and that's",
               "the problem.","","");
      if (get_pidx(0) == 4) then
        bubble(200,"Whatever.","","","");
      else
        bubble(200,"Oh... okay. Well, thanks",
                     "for your help.","","");
      end
      set_progress(9,1);
    end
