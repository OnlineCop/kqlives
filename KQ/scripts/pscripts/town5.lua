...
function postexec()
  if (get_progress(47) == 2) then
    ...
    set_progress(46,0);
    bubble(200,"Oh no!","","","");
    bubble(200,"I must have dropped",
                 "that key inside!","","");
...
function entity_handler(en)
  ...
  elseif (en == 1) then
    bubble(1,"I really like that guys' shirt.","","","");
  ...
  elseif (en == 7) then
    ...
    bubble(200,"Who are you? And who",
                 "are the Embers?","","");
    ...
    bubble(7,"Why yes! The Opal Helmet.",
             ...
             "one of them are you?","");
    bubble(200,"No. My name is $0. I am",
