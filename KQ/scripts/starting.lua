...
function postexec()
  ...
  wait_for_entity(HERO1, HERO1);
  bubble(HERO1, "Wait a minute! This Great Magic may be the answer I've been looking for to reverse this curse! I'm there man!");
  set_ent_script(HERO1, "F0W50");
  wait_for_entity(HERO1, HERO1);
  ...
  set_ent_script(HERO1, "U7");
  wait_for_entity(HERO1, HERO1);
  bubble(HERO1, "Ajathar:",
                "You wanted to see me sir?");
  bubble(24, "Yes Ajathar. It is time for you to leave the temple and discover the world. I have found the perfect way for you to do that.");
  ...
  bubble(24, "Aside from what adventure can teach you, it would be a good opportunity for you to investigate this whole quest. It seems a little suspicious.");
  ...
  bubble(25, "Yes Temmin, you are going to Reisha Mountain. You will likely find others there who are preparing for a quest.");
  ...
  bubble(25, "This man may pose no threat, but we will be safe instead of sorry. Understood?");
  ...
  thought(HERO1, "Ayla:",
                 "This is so perfect.");
  thought(HERO1, "Just as my luck starts running out, along comes an opportunity to get out of town and make some serious coin at the same time.");
  ...
  bubble(HERO1, "I would be the richest thief on the block. No! I'd be the richest girl... IN MY OWN CITY!");
  wait(100);
  remove_chr(AYLA);
