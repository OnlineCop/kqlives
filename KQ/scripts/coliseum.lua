  ...
  elseif (en == 12) then
    if (get_progress(P_OLDPARTNER) == 0) then
      ...
      bubble(12,"And let me just say that after",
                ...
                "answer!");
      bubble(HERO1,"Well, in that case, welcome to",
                   "the team.","","");
      bubble(HERO1,"Now, I already found the Opal",
                   "Helmet and the Opal Shield.","","");
      bubble(12,"So what about the other stuff?",
                "Do you already know where the",
                "Band and Armor are?","");
      bubble(HERO1,"No... no, I don't know where",
      ...
      bubble(HERO1,"I already snagged the Helmet and",
