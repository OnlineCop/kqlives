...
function entity_handler(en)
  if (en == 0) then
    ...
    if (get_progress(P_TALKDERIG) == 1) then
      bubble(0, "Tsorin? He should be around here somewhere.");
    end

  elseif (en == 1) then
    if (get_progress(P_TALKDERIG) == 1) then
      bubble(1, "Yes, I am Tsorin. I understand that you've been talking with Derig?");
      bubble(HERO1, "If you mean that old man back near Ekla, then yes. He told me to come here and see you.");
      bubble(1, "That is because I am the only one who can get you through the mountain pass and into the goblin lands.");
      bubble(1, "We currently have the pass sealed off to protect Andra.");
      bubble(HERO1, "Why do I need to go there?");
      bubble(1, "To find what you seek, you are going to have to visit the goblin Oracle. She has the information you require.");
      bubble(HERO1, "Why would a goblin help me?");
      bubble(1, "She is an Oracle, don't think of her as a Goblin. She knows how important this quest is, and she has information about it.");
      bubble(1, "She will help. I'm sure of it.");
      bubble(HERO1, "And if she doesn't? What do I do then? Kill her?");
      bubble(1, "No, that would not be wise. Don't worry, if you can get into the tower, she will know just how dire your need is.");
      bubble(HERO1, "What's with this tower? Is it a test of some sort, and by passing the test, I am allowed to talk to her?");
      bubble(1, "Sure, that's a good way of looking at it. I will tell you that the first part of the test is just getting into her tower.");
      bubble(1, "You can't enter without a goblin token.");
      bubble(HERO1, "Token?");
      bubble(1, "Well, I didn't know how else to word it. Basically, you're going to need something goblin-made.");
      bubble(1, "It could be anything, as long as it was made by goblins.");
      bubble(1, "And I think that it has to be magical.");
      bubble(HERO1, "So, how am I supposed to find something magical that was made by goblins?");
      bubble(1, "I was getting to that. You'll have to go to the temple north of here.");
      ...
      bubble(1, "In short, the temple is now empty and guarded by goblin spirits. It is extremely dangerous inside.");
      bubble(1, "However, the temple is the only place where you will find the token that you need.");
      bubble(HERO1, "Well... if there's no other way I guess I'm on my way to the temple then.");
      bubble(1, "By the way... I must tell you that you can only get to the lower levels of the temple by activating a hidden switch.");
      bubble(1, "The switch is hidden on an altar. The altar room should be easy to find.");
      bubble(HERO1, "Okay. Anything else?");
      bubble(1, "Not really, just come back here afterwards, and I'll get you through the mountain pass.");
      set_progress(P_TALKDERIG, 2);
      return;
    end
    if (get_progress(P_TALKDERIG) == 2 and get_progress(P_GOBLINITEM) == 1) then
      set_progress(P_TALKDERIG, 3);
      bubble(1, "Hey... you did it! Fantastic! Let's head to the fort.");
      do_fadeout(4);
      set_holdfade(1);
  ...
  elseif (en == 2) then
    bubble(2, "I wish the weapon shop sold slingshots.");
