...
void combat_skill(int who)
{
  ...
  if (sk == 4)
  {
    ...
    special_damage_oneall_enemies(who,40,R_ICE,999,1);
    dct = 0;
  ...
  if (sk == 9)
  {
    ...
    if (rand()%4 < 2)
    {
      ...
      special_damage_oneall_enemies(who,25,R_THUNDER,999,1);
      fighter[who].atrack[fighter[who].csmem] = 2;
      return;
    }
  ...
  if (sk == 10)
  {
    ...
    special_damage_oneall_enemies(who,40,R_POISON,999,1);
    fighter[who].atrack[fighter[who].csmem] = 3;
  }
  if (sk == 11)
  {
  ...
  if (sk == 13)
  {
    ...
    special_damage_oneall_enemies(who,60,R_EARTH,999,1);
    fighter[who].atrack[fighter[who].csmem] = 3;
  }
  if (sk == 14)
  {
