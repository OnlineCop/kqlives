...
*/
char curmap[16];
char icon_sets[6][16] = {"LAND_PCX","NEWTOWN_PCX","CASTLE_PCX","INCAVE_PCX","VILLAGE_PCX","MOUNT_PCX"};
int right,left,up,down,besc,balt,bctrl,benter;
int kright,kleft,kup,kdown,kesc,kenter,kalt,kctrl,jbalt,jbctrl,jbenter,jbesc;
...
BITMAP *cframes[NUM_FIGHTERS][MAXCFRAMES], *tcframes[NUM_FIGHTERS][MAXCFRAMES], *frames[MAXCHRS][MAXFRAMES];
BITMAP *eframes[MAXE][MAXEFRAMES], *pgb[9], *sfonts[5], *bord[8];
BITMAP *menuptr, *mptr, *sptr, *stspics, *sicons, *bptr, *missbmp, *noway, *upptr, *dnptr;
...
int noe=0,pidx[PSIZE],numchrs=0,gp=0,xofs,yofs,gsvol=250,gmvol=250;
unsigned char autoparty=0, autofollow=1, alldead=0, is_sound=1, deadeffect=0, vfollow=1, use_sstone=0;
unsigned char kq_version = 91, hold_fade = 0, cansave = 0, skip_intro = 0, wait_retrace=0, windowed = 0, stretch_view=0;
