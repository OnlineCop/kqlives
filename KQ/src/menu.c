        ...
        if (rd == 1)
          {
             drawmap ();
             draw_mainmenu (-1);
             draw_sprite (double_buffer, menuptr, 204 + xofs,
                          ptr * 8 + 73 + yofs);
        ...
        if (rd == 1)
          {
             ...
             for (a = 0; a < ii; a++)
               {
                  draw_icon (double_buffer, spicon[a], 88 + xofs,
                             a * 8 + 44 + yofs);
        ...
        if (rd == 1)
          {
             ...
             print_font (double_buffer, 8 + xofs, 128 + yofs, "Intellect",
                         FGOLD);
             print_font (double_buffer, 8 + xofs, 136 + yofs, "Sagacity",
                         FGOLD);
             ...
             print_font (double_buffer, 168 + xofs, 24 + yofs, "Earth",
                         FNORMAL);
             ...
             print_font (double_buffer, 168 + xofs, 96 + yofs, "Blind",
                         FNORMAL);
             print_font (double_buffer, 168 + xofs, 104 + yofs, "Charm",
                         FNORMAL);
             ...
             print_font (double_buffer, 168 + xofs, 128 + yofs, "Silence",
                         FNORMAL);
             print_font (double_buffer, 168 + xofs, 136 + yofs, "Sleep",
                         FNORMAL);
             print_font (double_buffer, 168 + xofs, 144 + yofs, "Time",
                         FNORMAL);
        ...
        if (j == 0)
          {
             ...
             if (items[a].icon == 1 || items[a].icon == 3
                 || items[a].icon == 21)
                tf.bstat = 1;
             else
                tf.bstat = 0;
